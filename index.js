...
// First, modify the MongoDB connection and adjustDatabasePoints sequence
mongoose.connect(MONGO_URI)
    .then(async () => {
...
// Remove the separate IIFE that calls adjustDatabasePoints

// Fix your server creation (use the http server instance you created)
server.listen(port, () => {
